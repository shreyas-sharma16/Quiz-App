...
def loginPage(logdata):
    ...
    heading = Label(login_frame,text="Quizi",fg="black",bg="white")
    heading.config(font=('Bahnschrift Light'))
...
def menu():
    ...
    wel = Label(menu_canvas,text=' W E L C O M E  T O  Q U I Z I ',fg="white",bg="#101357") 
...
def start():
    ...
    button.configure(width = 50,height=2, activebackground = "#33B5E5", bg ='green', relief = RAISED)
